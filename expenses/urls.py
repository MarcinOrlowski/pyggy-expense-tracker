...
urlpatterns = [
    ...
    path(
        "budgets/<int:budget_id>/expenses/create/",
        views.expense_create,
        name="expense_create",
    ),
    path(
        "budgets/<int:budget_id>/expenses/<int:pk>/",
        views.expense_detail,
        name="expense_detail",
    ),
    path(
        "budgets/<int:budget_id>/expenses/<int:pk>/edit/",
        views.expense_edit,
        name="expense_edit",
    ),
    path(
        "budgets/<int:budget_id>/expenses/<int:pk>/delete/",
    ...
    path(
        "budgets/<int:budget_id>/months/<int:year>/<int:month>/",
        views.month_detail,
        name="month_detail",
    ),
    path(
        "budgets/<int:budget_id>/months/<int:year>/<int:month>/delete/",
        views.month_delete,
        name="month_delete",
    ),
    path(
        "budgets/<int:budget_id>/months/process/",
        views.month_process,
        name="month_process",
    ),
    # Payment Processing (budget-scoped)
    path(
        "budgets/<int:budget_id>/expense-items/<int:pk>/pay/",
        views.expense_item_pay,
        name="expense_item_pay",
    ),
    path(
        "budgets/<int:budget_id>/expense-items/<int:pk>/unpay/",
        views.expense_item_unpay,
        name="expense_item_unpay",
    ),
    path(
        "budgets/<int:budget_id>/expense-items/<int:pk>/edit/",
        views.expense_item_edit,
        name="expense_item_edit",
    ),
    path(
        "budgets/<int:budget_id>/expense-items/<int:pk>/payments/",
