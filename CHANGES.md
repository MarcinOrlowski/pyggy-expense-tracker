...
- [#0140] Simplified list UI by making entire table rows clickable for view actions, removing dedicated view icons to reduce visual clutter and improve usability
