...
class BudgetModelTest(TestCase):
    ...
    def test_budget_default_initial_amount(self):
        ...
        budget = Budget.objects.create(name="Zero Budget", start_date=date(2024, 1, 1))
...
class BudgetRelationshipTest(TestCase):
    ...
    def test_budget_can_delete_method(self):
        ...
        empty_budget = Budget.objects.create(
            name="Empty Budget", start_date=date(2024, 3, 1)
        )
...
class ProcessNewMonthWithBudgetTest(TestCase):
    ...
    def test_process_new_month_requires_budget_parameter(self):
        ...
        self.assertIn(
            "missing 1 required positional argument: 'budget'", str(context.exception)
        )
    ...
    def test_process_new_month_with_budget(self):
        ...
        default_budget = Budget.objects.create(
            name="Default", start_date=date(2024, 1, 1), initial_amount=Decimal("0")
        )
    ...
    def test_process_new_month_assigns_budget_to_existing_month(self):
        ...
        budget, _ = Budget.objects.get_or_create(
            name="Default",
            defaults={"start_date": date(2024, 1, 1), "initial_amount": Decimal("0")},
        )
...
class BudgetOrderingTest(TestCase):
    ...
    def test_budget_ordering_by_name(self):
        ...
        Budget.objects.create(name="Zebra Budget", start_date=date(2024, 1, 1))
        Budget.objects.create(name="Alpha Budget", start_date=date(2024, 1, 1))
        Budget.objects.create(name="Middle Budget", start_date=date(2024, 1, 1))
